...
# input = torch.randn(2,9,17,2)
# flops, _ = profile(model_pos_train,inputs=(input,))
# print('flops: ', flops)
# from fps import measure_inference_speed
# measure_inference_speed(model_pos_train, (input,))

# from torchsummaryX import summary
# input = torch.randn(1,9,17,2)
# summary(model_pos,input)

# from ptflops import get_model_complexity_info
# flops, params = get_model_complexity_info(model_pos, (81,17,2), as_strings=True, print_per_layer_stat=True)
